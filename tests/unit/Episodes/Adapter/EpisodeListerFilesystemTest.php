...
use PodcastSiteCore\Episodes\EpisodeLister;
use Mni\FrontYAML\Parser;

/**
 * Class EpisodeListerFilesystem
 *
 * @coversDefaultClass \PodcastSiteCore\Episodes\Adapter\EpisodeListerFilesystem
 */
...
EOF;
        ...
        $this->assertInstanceOf('\PodcastSiteCore\Entity\Episode', $episode, 'Built episode is not an Episode instance');
...
EOF;
    ...
    public function testEpisodeListerImplementsCorrectInterface()
    {
        ...
        $this->assertInstanceOf('\PodcastSiteCore\Episodes\EpisodeListerInterface', $episodeLister);
    }
