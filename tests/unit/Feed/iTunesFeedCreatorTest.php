...
use PodcastSiteCore\Feed\iTunesFeedCreator;
use PodcastSiteCore\Entity\Show;

/**
 * Class iTunesFeedCreatorTest
 *
 * @coversDefaultClass \PodcastSiteCore\Feed\iTunesFeedCreator
 */
...
EOF;
        ...
        $this->episodeList[] = new \PodcastSiteCore\Entity\Episode($options);
