...
namespace PodcastSiteCore\Episodes\Adapter;

use PodcastSiteCore\Episodes\EpisodeListerInterface;
use PodcastSiteCore\Iterator\ActiveEpisodeFilterIterator;
use PodcastSiteCore\Sorter\SortByReverseDateOrder;
use PodcastSiteCore\Entity\Episode;
use PodcastSiteCore\Iterator\UpcomingEpisodeFilterIterator;
use PodcastSiteCore\Iterator\PastEpisodeFilterIterator;
...
class EpisodeListerFilesystem implements EpisodeListerInterface
{
     ...
     *
     * @param \PodcastSiteCore\Entity\Episode|null $episode
     */
     ...
     *
     * @return \PodcastSiteCore\Entity\Episode
     */
